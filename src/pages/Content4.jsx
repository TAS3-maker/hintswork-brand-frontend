                ...
                <div className="w-full max-w-[1050px] 2xl:max-w-[1250px] m-auto px-4">
                    ...
                    <div className="flex flex-col-reverse md:flex-row-reverse items-start md:items-center justify-start md:justify-center gap-4 md:gap-8">
                        <div className="w-full max-w-1/2 relative">
                            ...
                            <p className="font-montserrat font-medium text-base md:text-lg 2xl:text-2xl text-[#525252] mb-2">At HintsWork, every hint is rooted in<span className="font-bold">behavioral science + nutrition </span>research.</p>
                            <div className="flex flex-col gap-3">
                                <div className="flex items-start justify-start gap-2 md:gap-4">
                                    ...
                                    <p className="font-montserrat font-normal text-base 2xl:text-xl text-[#525252]">BJ Fogg's Behavior Model shows tiny habits lead to lasting change.</p>
                                </div>
                                ...
                                <div className="flex items-start justify-start gap-2 md:gap-4 mt-1">
                                    ...
                                    <p className="font-montserrat font-normal text-base 2xl:text-xl text-[#525252]">Harvard studies prove visual progress (like points & trophies) doubles adherence.</p>
                                </div>

                                <div className="flex items-start justify-start gap-2 md:gap-4 mt-1">
                                    <img src={check} alt="check" className="w-5 sm:w-6 md:w-8 h-5 sm:h-6 md:h-8" />
                                    <p className="font-montserrat font-normal text-base 2xl:text-xl text-[#525252]">Choice Architecture ensures the healthier option feels easier, not forced.</p>
                                </div>

                                

                                <div className="flex justify-start ">
                                    <p className="font-montserrat font-normal text-base 2xl:text-xl text-[#525252]">That's why HintsDiet isn't a lecture. It's a friendly nudge, at the right time, validated by Science Says... </p>
                                </div>
                            </div>
