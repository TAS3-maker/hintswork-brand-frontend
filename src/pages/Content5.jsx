...
import Cypfree from "../pages/images/cypfree.png";
import Cypstart from "../pages/images/cypstart.png";
import Cyppro from "../pages/images/cyppro.png";
import Redcheck from "../pages/images/redcheck.svg";
import Whitecheck from "../pages/images/whitecheck.svg"
export default function Content5() {
   const plans = [
    { img: Cypfree, title: 'Free', price:'$0', desc: 'HintAll + HintJoy - bundles/day', icon: Redcheck },
    { img: Cypstart, title: 'Starter', price:'$5', desc: 'Any 2 paid brands + HintAll + HintJoy · 12 bundles/day', icon: Redcheck },
    { img: Cyppro, title: 'Pro', price:'$15', desc: ' All brands + HintAll + HintJoy · 21 bundles/day', icon: Whitecheck },
  ];
  return (
        ...
        {plans.map(({ img, title, price, desc, icon }, idx) => (
          ...
          >
            <div className="pb-6 rounded-lg text-center w-[281px] sm:w-[375px] md:w-[100%]">
              ...
              <p className={`text-2xl font-semibold pb-2 ${title === 'Pro' ? 'text-white' : 'text-black'}`}>
                {title}
              </p>
              <p className={`text-2xl border-b pb-2 ${title === 'Pro' ? 'text-white border-white' : 'text-black border-black'}`}>
                {price}
              </p>
              <div className='flex gap-1 w-full max-w-[232px] m-auto pt-2'>
